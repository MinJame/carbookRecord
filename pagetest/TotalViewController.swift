        ...
        if let list : [Dictionary<String,Any>] = carbookDataBase.selectRangeyearCarBookDataList(year: year) {
            ...
            for (key,value) in groupRawData {
                ...
                for item in value {
                    ...
                    monthDates = item["dates"] as? String ?? ""
                }
                dates = monthDates
            ...
            carDataList = carDataList.sorted {$0["dates"] as? String ?? "" > $1["dates"] as? String ?? ""}
        }
...
extension TotalViewController: UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        if fuelId != "" {
            ...
            cell.changeItemButton.addTarget(self, action: #selector(changeRepairItem(_:)), for: .touchUpInside)
